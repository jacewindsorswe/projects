...
{
    public class PushableBlock : IBlockState
    {
        //Controls whether or not the block is allowed to be pushed
        ...
        private CollidableObject.Type collidableType = CollidableObject.Type.PushableBlock;
